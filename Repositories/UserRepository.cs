...
public class UserRepository(UserDbContext userDbContext, IMapper mapper) : IUserRepository
{
    ...
    // public PaginationResponse<IEnumerable<ReadUserDTO>> GetAllUsers(UserFilter userFilter)
    // {
    //     try
    //     {
    //         IEnumerable<User> users = userDbContext.Users.Where(x=>x.IsDeleted==false);
    ...
    //     {
    //         System.Console.WriteLine(ex.Message);
    //         throw new Exception("Information was not found.");
    //     }
    // }
